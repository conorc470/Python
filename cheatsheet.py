...
# To set value for a certain key if it doesnt already have a value
super_villains.setdefault('color', 'black')

# To print dictionarys values in an easier to read way
import pprint
pprint.pprint(super_villains)
